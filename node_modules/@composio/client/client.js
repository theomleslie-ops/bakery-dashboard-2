...
const cli_1 = require("./resources/cli/cli.js");
const logs_1 = require("./resources/logs/logs.js");
const mcp_1 = require("./resources/mcp/mcp.js");
const project_1 = require("./resources/project/project.js");
const tool_router_1 = require("./resources/tool-router/tool-router.js");
...
class Composio {
    ...
    constructor({ baseURL = (0, env_1.readEnv)('COMPOSIO_BASE_URL'), apiKey = (0, env_1.readEnv)('COMPOSIO_API_KEY') ?? null, ...opts } = {}) {
        ...
        this.project = new API.Project(this);
        this.logs = new API.Logs(this);
        this.toolRouter = new API.ToolRouter(this);
        const options = {
            apiKey,
            ...opts,
            baseURL,
        ...
        const customHeadersEnv = (0, env_1.readEnv)('COMPOSIO_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildBody({ options }) {
        ...
        if (!body) {
            ...
            if (body == null && 'body' in options) {
                return tslib_1.__classPrivateFieldGet(this, _Composio_encoder, "f").call(this, { body, headers: (0, headers_1.buildHeaders)([rawHeaders]) });
            }
...
Composio.Project = project_1.Project;
Composio.Logs = logs_1.Logs;
Composio.ToolRouter = tool_router_1.ToolRouter;
