...
export declare namespace SessionLinkResponse {
    /**
     * Experimental features - not stable, may be modified or removed in future
     * versions.
     */
...
export interface SessionExecuteMetaParams {
     ...
     */
    slug: 'COMPOSIO_SEARCH_TOOLS' | 'COMPOSIO_MULTI_EXECUTE_TOOL' | 'COMPOSIO_MANAGE_CONNECTIONS' | 'COMPOSIO_WAIT_FOR_CONNECTIONS' | 'COMPOSIO_REMOTE_WORKBENCH' | 'COMPOSIO_REMOTE_BASH_TOOL' | 'COMPOSIO_GET_TOOL_SCHEMAS';
    /**
...
export interface SessionProxyExecuteParams {
     ...
     * content_type?: "..."}.
     */
    binary_body?: SessionProxyExecuteParams.BinaryBodyUnionMember0 | SessionProxyExecuteParams.BinaryBodyUnionMember1;
    /**
...
export declare namespace SessionProxyExecuteParams {
    ...
    interface BinaryBodyUnionMember1 {
        /**
