...
class Tools extends resource_1.APIResource {
    ...
    retrieve(toolSlug, query = {}, options) {
        return this._client.get((0, path_1.path) `/api/v3.1/tools/${toolSlug}`, { query, ...options });
    }
    /**
    ...
    execute(toolSlug, params = {}, options) {
        ...
        return this._client.post((0, path_1.path) `/api/v3.1/tools/execute/${toolSlug}`, {
            body,
            ...options,
    ...
    getInput(toolSlug, body, options) {
        return this._client.post((0, path_1.path) `/api/v3.1/tools/execute/${toolSlug}/input`, { body, ...options });
    }
    /**
